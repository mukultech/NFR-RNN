def multi_classifier(train_data):
	...
	## Training the model ##
         ...
         history = model.fit(array(sequences_train[train]), Y_train[train], batch_size=50, epochs=1, validation_data=(sequences_train[validation], Y_train[validation]), verbose=0,class_weight=class_weight)  # starts training
